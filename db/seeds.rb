...
caitlin = Camper.create(name: 'Caitlin',age: 8)
lizzie = Camper.create(name: 'Lizzie', age: 9)
tom = Camper.create(name: 'Tom', age: 12)
...
archery = Activity.create(name: 'Archery', difficulty: 2)
swimming = Activity.create(name: 'Swimming', difficulty: 3)
photography = Activity.create(name: 'Photography', difficulty: 2)
